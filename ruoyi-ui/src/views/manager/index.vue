<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['manager:manager:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['manager:manager:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['manager:manager:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['manager:manager:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="managerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="城管id" align="center" prop="id" />
      <el-table-column label="名字" align="center" prop="managerName" />
      <el-table-column label="电话号码" align="center" prop="tel" />
      <el-table-column label="邮箱" align="center" prop="emile" />
      <el-table-column label="用户类型" align="center" prop="userType" />
      <el-table-column label="创建时间" align="center" prop="joinTime" width="180">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="姓名" prop="managerName">
          <el-input v-model="form.managerName" placeholder="" />
        </el-form-item>
        ...
        <el-form-item label="邮箱" prop="emile">
          <el-input v-model="form.emile" placeholder="" />
        </el-form-item>
...
<script>
import { listManager, getManager, delManager, addManager, updateManager } from "@/api/manager/manager.js";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除管理员信息管理编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('manager/manager/export', {
        ...this.queryParams
